...
import 'package:Radar/utils/LogoutDialog.dart';
...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer2<ProfileController, RequestsController>(builder: (context, _controller, _, child) {
      if (_controller.roles.requestCreater.connectionState == util.ConnectionState.Disconnected ||
          _controller.roles.requestCreater.connectionState == util.ConnectionState.Connected) {
        return Scaffold(
          appBar: AppBar(
            title: Text('Profile'),
            ...
            children: <Widget>[
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    CircleAvatar(
                      backgroundImage: AssetImage('assets/profile_screen/profile_pic.png'),
                      radius: 50,
              ...
              if (_controller.roles.requestCreater.doRequestDetailsExist())
                Align(
                  ...
                  child: InkWell(
                    child: MyRequestBar(
                      myRequestTitle: _controller.roles.requestCreater.requestTitle,
                      cancelMyRequest: _controller.cancelMyRequest,
                    ),
                    onTap: () => showModalBottomSheet(
                      builder: (context) => MyRequestDetails(
                        myRequestTitle: _controller.roles.requestCreater.requestTitle,
                        myRequestDescription: _controller.roles.requestCreater.requestDescription,
                      ),
                      context: context,
